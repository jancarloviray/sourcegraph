...
type Build struct {
	...
	// User is who created the build, or who the build was created for.
	User *UserSpec `protobuf:"bytes,16,opt,name=User" json:"User,omitempty"`
...
type BuildJob struct {
	...
	// CommitID is the full resolved commit ID to build.
	CommitID string `protobuf:"bytes,3,opt,name=CommitID,proto3" json:"CommitID,omitempty"`
	// User is the user who to build on behalf of.
	User *UserSpec `protobuf:"bytes,17,opt,name=User" json:"User,omitempty"`
	// Branch, if set, is the name of the VCS branch on which this
...
type BuildsCreateOp struct {
	...
	// required.
	CommitID string `protobuf:"bytes,2,opt,name=CommitID,proto3" json:"CommitID,omitempty"`
	// User is who to create the build for. This is the current user by
	// default, and can only be set by internal authed scopes.
	User *UserSpec `protobuf:"bytes,6,opt,name=User" json:"User,omitempty"`
...
func (m *BuildJob) MarshalTo(data []byte) (int, error) {
	...
	if m.User != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.User.Size()))
		n35, err := m.User.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *BuildsCreateOp) MarshalTo(data []byte) (int, error) {
	...
	if m.User != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.User.Size()))
		n47, err := m.User.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *BuildsListBuildTasksOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Build.Size()))
	n50, err := m.Build.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n50
...
func (m *BuildsUpdateTaskOp) MarshalTo(data []byte) (int, error) {
	...
	n53, err := m.Task.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n53
...
func (m *BuildsGetTaskLogOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Task.Size()))
	n55, err := m.Task.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n55
	if m.Opt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Opt.Size()))
		n56, err := m.Opt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n56
...
func (m *Org) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.User.Size()))
	n57, err := m.User.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n57
...
func (m *OrgListMembersOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n58, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n58
...
func (m *OrgsListMembersOp) MarshalTo(data []byte) (int, error) {
	...
	n59, err := m.Org.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n59
...
func (m *Person) MarshalTo(data []byte) (int, error) {
	...
	n61, err := m.PersonSpec.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n61
...
func (m *TaskUpdate) MarshalTo(data []byte) (int, error) {
	...
	if m.StartedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.StartedAt.Size()))
		n63, err := m.StartedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n63
	...
	if m.EndedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.EndedAt.Size()))
		n64, err := m.EndedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *User) MarshalTo(data []byte) (int, error) {
	...
	if m.RegisteredAt != nil {
		...
		n65, err := m.RegisteredAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n65
...
func (m *OrgsListOp) MarshalTo(data []byte) (int, error) {
	...
	n67, err := m.Member.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n67
...
func (m *NewPassword) MarshalTo(data []byte) (int, error) {
	...
	if m.Token != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Token.Size()))
		n70, err := m.Token.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n70
...
func (m *AccessTokenRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.AuthorizationGrant != nil {
		nn71, err := m.AuthorizationGrant.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn71
...
func (m *AccessTokenRequest_ResourceOwnerPassword) MarshalTo(data []byte) (int, error) {
	...
	if m.ResourceOwnerPassword != nil {
		...
		n72, err := m.ResourceOwnerPassword.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n72
...
func (m *AccessTokenRequest_GitHubAuthCode) MarshalTo(data []byte) (int, error) {
	...
	if m.GitHubAuthCode != nil {
		...
		n73, err := m.GitHubAuthCode.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n73
...
func (m *AccessTokenResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.GitHubUser != nil {
		...
		n74, err := m.GitHubUser.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n74
...
func (m *Def) MarshalTo(data []byte) (int, error) {
	...
	n75, err := m.Def.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n75
	if m.DocHTML != nil {
		...
		n76, err := m.DocHTML.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n76
	...
	if m.FmtStrings != nil {
		...
		n77, err := m.FmtStrings.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n77
...
func (m *DefList) MarshalTo(data []byte) (int, error) {
	...
	n82, err := m.ListResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n82
...
func (m *DefsListRefsOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Def.Size()))
	n83, err := m.Def.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n83
	if m.Opt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Opt.Size()))
		n84, err := m.Opt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n84
...
func (m *RefList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n85, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n85
...
func (m *RefLocationsList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n89, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n89
...
func (m *Delta) MarshalTo(data []byte) (int, error) {
	...
	n90, err := m.Base.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n90
	...
	n91, err := m.Head.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n91
	if m.BaseCommit != nil {
		...
		n92, err := m.BaseCommit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n92
	...
	if m.HeadCommit != nil {
		...
		n93, err := m.HeadCommit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n93
...
func (m *FileDiff) MarshalTo(data []byte) (int, error) {
	...
	n94, err := m.FileDiff.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n94
...
func (m *DeltaFiles) MarshalTo(data []byte) (int, error) {
	...
	if m.Delta != nil {
		...
		n96, err := m.Delta.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n96
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Stats.Size()))
	n97, err := m.Stats.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n97
...
func (m *DeltaListFilesOptions) MarshalTo(data []byte) (int, error) {
	...
	n98, err := m.DeltaFilter.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n98
...
func (m *DeltasListFilesOp) MarshalTo(data []byte) (int, error) {
	...
	n101, err := m.Ds.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n101
...
func (m *RepoTreeGetOptions) MarshalTo(data []byte) (int, error) {
	...
	n103, err := m.GetFileOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n103
...
func (m *GetFileOptions) MarshalTo(data []byte) (int, error) {
	...
	n104, err := m.FileRange.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n104
...
func (m *RepoTreeSearchOptions) MarshalTo(data []byte) (int, error) {
	...
	n105, err := m.SearchOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n105
...
func (m *RepoTreeSearchResult) MarshalTo(data []byte) (int, error) {
	...
	n106, err := m.SearchResult.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n106
	...
	n107, err := m.RepoRev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n107
...
func (m *RepoTreeGetOp) MarshalTo(data []byte) (int, error) {
	...
	n108, err := m.Entry.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n108
	if m.Opt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Opt.Size()))
		n109, err := m.Opt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n109
...
func (m *RepoTreeSearchOp) MarshalTo(data []byte) (int, error) {
	...
	n110, err := m.Rev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n110
...
func (m *RepoTreeListOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Rev.Size()))
	n112, err := m.Rev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n112
...
func (m *VCSSearchResultList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListResponse.Size()))
	n113, err := m.ListResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n113
...
func (m *TreeEntry) MarshalTo(data []byte) (int, error) {
	...
	if m.BasicTreeEntry != nil {
		...
		n114, err := m.BasicTreeEntry.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n114
...
func (m *AuthorshipInfo) MarshalTo(data []byte) (int, error) {
	...
	n117, err := m.LastCommitDate.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n117
...
func (m *DefAuthor) MarshalTo(data []byte) (int, error) {
	...
	n118, err := m.DefAuthorship.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n118
...
func (m *DefAuthorship) MarshalTo(data []byte) (int, error) {
	...
	n119, err := m.AuthorshipInfo.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n119
...
func (m *DefsListAuthorsOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Def.Size()))
	n121, err := m.Def.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n121
...
func (m *FileToken) MarshalTo(data []byte) (int, error) {
	...
	if m.Entry != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Entry.Size()))
		n123, err := m.Entry.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n123
...
func (m *UserEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.CreatedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.CreatedAt.Size()))
		n124, err := m.CreatedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n124
...
func (m *Event) MarshalTo(data []byte) (int, error) {
	...
	if m.Timestamp != nil {
		...
		n125, err := m.Timestamp.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n125
...
func (m *NotifyGenericEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.Actor != nil {
		...
		n126, err := m.Actor.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n126
...
func (m *AnnotationsListOptions) MarshalTo(data []byte) (int, error) {
	...
	if m.Range != nil {
		...
		n128, err := m.Range.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n128
...
func (m *RepoSearchResult) MarshalTo(data []byte) (int, error) {
	...
	if m.Repo != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Repo.Size()))
		n131, err := m.Repo.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n131
...
func (m *ChannelSendOp) MarshalTo(data []byte) (int, error) {
	...
	n133, err := m.Action.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n133
...
var fileDescriptorSourcegraph = []byte{
	...
	,
}
